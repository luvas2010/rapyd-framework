...
class edit_grid_controller extends rpd {
	...
	public function comment()
	{
			...
			$comment_config = array	(
				...
				'source' => 'comments',
				'back_url'=> 'edit_grid/comment?show='.rpd_url_helper::value('show'),
				'back_save' => true,
				'back_undo' => true,
				'fields' => array (
						array(
							'type'  => 'hidden',
							'name'  => 'article_id',
							'insert_value' => rpd_url_helper::value('show'),
						),
						array(
							'type'  => 'textarea',
							'name'  => 'comment',
			...
			//$article_edit->nest('comments',$comment_edit);
			//$article_edit->nest('comments',$comments_grid);
